...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=ListeStage::class, mappedBy="user")
     */
    private $listeStages;
    ...
    /**
     * @return Collection<int, ListeStage>
     */
    ...
    public function addListeStage(ListeStage $listeStage): self
    {
        if (!$this->listeStages->contains($listeStage)) {
            $this->listeStages[] = $listeStage;
            $listeStage->setUser($this);
        }

        return $this;
    }

    public function removeListeStage(ListeStage $listeStage): self
    {
        if ($this->listeStages->removeElement($listeStage)) {
            // set the owning side to null (unless already changed)
            if ($listeStage->getUser() === $this) {
                $listeStage->setUser(null);
            }
        }
